 ...
 *          if (!PermissionUtils.isGranted(PermissionConstants.STORAGE)) {
            ...
            .callback(new PermissionUtils.FullCallback() {
                    @Override
                    public void onGranted(List<String> permissionsGranted) {//授予
                        授予权限回调
                    }

                    @Override
                    public void onDenied(List<String> permissionsDeniedForever, List<String> permissionsDenied) {//否认
                        拒绝授予权限回调
                    }
            })
            .request();
...
public final class PermissionUtils {
     ...
     * 请求权限
     *
     * @param permissions 带请求的权限
     * @return 当前 {@link PermissionUtils} 实例
     */
    ...
    /**
     * 设置权限请求列表请求结果回调，多权限请求，授予的权限列表与拒绝授予的权限列表
     *
     * @param callback 多权限请求时具体权限请求回调结果
     * @return 当前 {@link PermissionUtils} 实例
     */

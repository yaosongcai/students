...
public final class BarUtils {
     ...
     *
     * @param activity    当前Activity
     * @param isLightMode true-设置 false - 不设置
     */
     ...
     * @param color    状态栏颜色
     * @param alpha    透明度
     * @param isDecor  true - 添加状态栏风格，false-不添加
     */
    public static void setStatusBarColor(@NonNull final Activity activity,
                                         @ColorInt final int color,
                                         @IntRange(from = 0, to = 255) final int alpha,
     ...
     * <p>DrawLayout 都要添加 {@code android:fitsSystemWindows="true"}这条属性</p>
     *
     * @param activity      当前Activity
     * @param drawer        当前DrawerLayout
     * @param fakeStatusBar 状态栏view
     * @param color         颜色
     * @param isTop
     */

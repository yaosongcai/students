...
public final class AppUtils {
     ...
     * @param activity
     * @param filePath
     * @param requestCode 返回码  在{@link Activity#onActivityResult(int, int, Intent)}处理
     */
     ...
     *
     * @param filePath
     * @param params   该参数详细可了解 adb的install命令行参数installation(e.g.,<code>-r</code>, <code>-s</code>).
     * @return {@code true}: 成功<br>{@code false}: 失败
     */
     ...
     *
     * @param packageName
     * @return {@code true}: 安装<br>{@code false}: 未安装
     */

 ...
 */
package com.wq.utils.view.widget.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.wq.utils.view.widget.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.wq.utils.view.widget.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mDelegate != null) {
            ...
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(CalendarUtil.dipToPx(getContext(), 30), MeasureSpec.EXACTLY);
        }

...
import com.wq.utils.view.xbanner.transformers.BasePageTransformer;
import com.wq.utils.view.xbanner.transformers.Transformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        mClipChildrenTopMargin = XBannerUtils.dp2px(context, 10);
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            mClipChildrenTopMargin = typedArray.getDimensionPixelSize(R.styleable.XBanner_clipChildrenTopMargin,mClipChildrenTopBottomMargin);
    ...
    /**
     * 动态设置上边距
     * @param mClipChildrenTopMargin
     */
    public void setClipChildrenTopMargin(int mClipChildrenTopMargin){
        this.mClipChildrenTopMargin = mClipChildrenTopMargin;
    }
    ...
    private void initViewPager() {
        ...
        if (mIsClipChildrenMode) {
            ...
            layoutParams.topMargin = mClipChildrenTopMargin;//mClipChildrenTopBottomMargin

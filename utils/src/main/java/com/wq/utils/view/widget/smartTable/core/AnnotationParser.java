...
import com.wq.utils.view.widget.smartTable.annotation.ColumnType;
import com.wq.utils.view.widget.smartTable.annotation.SmartColumn;
import com.wq.utils.view.widget.smartTable.data.column.ArrayColumn;
...
import com.wq.utils.view.widget.smartTable.exception.TableException;
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(com.wq.utils.view.widget.smartTable.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    com.wq.utils.view.widget.smartTable.annotation.SmartTable table = (com.wq.utils.view.widget.smartTable.annotation.SmartTable) tableAnnotation;

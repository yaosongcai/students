...
import com.wq.utils.view.widget.BaseGroupRecyclerAdapter;
...
public abstract class GroupRecyclerAdapter<Parent, Child> extends BaseGroupRecyclerAdapter<Child> {

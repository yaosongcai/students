package com.wq.utils.imagetrans;
...
import com.wq.utils.util.FileUtils;
import com.wq.utils.util.MathUtils;
...
public class TileBitmapDrawable extends Drawable {
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            final float minScale = Math.min(ScreenUtils.getScreenWidth() / (float) decoder.getWidth(), ScreenUtils.getScreenHeight() / (float) decoder.getHeight());
            ...
            try {
                ...
                if (null == bitmap) {
                    //下载的图片有问题,将其删掉
                    FileUtils.deleteFile((String) params[0]);

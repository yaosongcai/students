...
import com.wq.students.base.utils.Constant.Constant;
import com.wq.utils.util.SPUtils;
...
//                .addQueryParameter("user_id", SPUtils.getInstance().getString(Constant.USER_ID))
                .addQueryParameter("user_id", "e8a787813c42497cb3c613fbd0f9a919")
                .addQueryParameter("orgname",SPUtils.getInstance().getString(Constant.ORGNAME))
                .build();
        Request.Builder requestBuilder = originalRequest.newBuilder()
                .addHeader("user-agent","cqwqkjAndroid")
